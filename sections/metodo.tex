...
\end{easylist}
\vspace*{0.3cm}
\noindent Com a aplicação da metodologia, simplificada no Fluxograma da Figura \ref{fig:figura8}, busca-se identificar se há 
...
\input{subsec/levant.tex}
\input{subsec/padroes.tex}
\input{subsec/niveis.tex}
\input{subsec/defmodelos.tex}
