...
\begin{titlepage}
    \begin{center}
        \begin{figure}
            \centering
            \includegraphics[scale=0.7]{F:\Root Files\Academic\masters\_desenvolvimento\_regular\_dissertacao\fase final\_estrutura\_texto\tex\figures\figures\brasao-rep-br.png}
        \end{figure}
        \vspace*{3cm}
