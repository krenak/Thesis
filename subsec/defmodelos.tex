...
etapas metodológicas e estão dispostos no Fluxograma da Figura \ref{fig:figura10}.\vspace*{0.3cm} \newline
    \begin{figure}[ht]
        \centering
        \small \caption{Fatores utilizados como parâmetros de configuração volumétrica dos modelos genéricos.}
        \includegraphics[width=0.1\textwidth]{figures/fig10_Fluxogramas-2.jpg}
        \begin{flushleft}
